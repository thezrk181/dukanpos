...
function Summary({ state }: { state: State }) {
  ...
  <div className="hidden print:block print-receipt max-w-sm mx-auto mt-8 font-mono text-xs">
    <div className="text-center"><div className="font-display text-2xl text-primary">dukan</div><p className="mt-1 text-[10px] text-muted-foreground">Al-Khan General Store</p><p className="mt-1 text-[10px] text-muted-foreground">End of Day: {new Date().toLocaleDateString('en-PK')}</p></div>
    <div className="my-4 border-t border-dashed border-border" />
